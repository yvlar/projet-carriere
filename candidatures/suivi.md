...
> Mettre à jour ce tableau **le jour même** de chaque action (envoi, relance, réponse, entrevue).
> Règle de relance : sans réponse après **10-14 jours**, relance courte et polie avec le lien github.com/yvlar.
...
|---|---|---|---|---|---|---|---|
| | Infinition inc. (Trois-Rivières) | Développeur(euse) logiciel — permanent | Indeed : https://to.indeed.com/aab28mt22g74 | via l'offre Indeed | 🔜 | | PME ~10 personnes, radars de précision/défense. Exige C/C++, POO, Windows/Linux, « bac ou formation équivalente » ; atouts CMake, Git, Python, C#. **Mentionner SwingBot dès la 1re ligne** — lettre : `lettres/infinition.md` |
| | Sogenix (Drummondville) | Programmeur(se) en automatisation — permanent | Courriel (offre : https://to.indeed.com/aajrlwnmfwjm) | rh@sogenix.com | 🔜 | | Automates Allen-Bradley/Siemens/Omron, projets agroalimentaires région Victoriaville/Drummondville/Sorel. Exige DEC ou bac + « 3 à 10 ans d'expérience pertinente de projets en usine » — **mes 10 ans ContiTech répondent mot pour mot**. Lettre : `lettres/sogenix.md` |
| | Transport scolaire Sogesco (Drummondville) | Programmeur(euse) — permanent | Indeed : https://to.indeed.com/aajd2m4zxjrn | via l'offre Indeed | 🔜 | | Affichée le 15 juin 2026. **Correspondance quasi parfaite** : « DEC/AEC ou toute autre formation pertinente », SQL intermédiaire, profil full-stack, tests unitaires, permis de conduire, et « former et soutenir les utilisateurs » = mon poste actuel de formateur. WinDev = atout seulement. Lettre : `lettres/sogesco.md` |
| | Canimex (Drummondville) | Programmeur automatisme en production | Courriel / téléphone | recrutement@canimex.com · 819-477-1335 | 🔜 | | Appeler ou écrire pour vérifier le poste ouvert et le processus. Réutiliser la trame de la lettre Sogenix (adapter). |
| | EMBLÈME (Drummondville) | Développeur programmeur web — permanent | Indeed : https://to.indeed.com/aagqzw2sx8dm | formulaire de l'offre | 🔜 | | 2e vague. Agence web : PHP/JS/MySQL/WordPress/HTML5 — « compétence > parcours académique ». Affichée en février 2026 : vérifier si toujours ouverte. Demandent 5 liens de sites web livrés (mon portfolio = applications, pas des sites — à cadrer). |
...
| Date | Entreprise | Événement | Détails / prochaine étape |
|---|---|---|---|
| | | | |
